...
new Vue({
    ...
    methods: {
      register: function(event) {
          ...
          uibuilder.send( {
              ...
              'payload': {
                  'type': 'Register',
                  'user': this.inputText,
                  'pass': this.inputPassw,
                  'pass2': this.inputPassw2,
              }
          } )
      ...
      login: function(event) {
          ...
          uibuilder.send( {
              ...
              'payload': {
                  'type': 'Login',
                  'user_login': this.inputText_login,
                  'pass_login': this.inputPassw_login,
              }
          } )
    ...
    mounted: function(){
        ...
        uibuilder.onChange('msg', function(msg){
            ...
            if (msg.topic == 'status_login') {
              var texto = msg.payload
              app.status_login = texto
              if (texto == "Logged in!") {
                window.location.href = '../exemplo1'; //one level up
